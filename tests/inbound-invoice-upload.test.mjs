...
test("거래명세서는 입고 저장 전에 Google Drive에 즉시 업로드한다", () => {
  ...
  assert.match(adminHtml, /admin\.js\?v=20260910-(?:inventory-attachments|update-history(?:-v2)?|notification-scroll-v3|production-plan-tabs-v1|production-plan-product-v[23])-(?:dev|prd)/);
});
