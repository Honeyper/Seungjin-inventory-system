...
test("PC 제품 이미지와 하단 썸네일 영역 사이에 여백을 유지한다", () => {
  ...
  assert.match(adminHtml, /styles\.css\?v=20260910-(?:invoice-preview-clear|update-history|notification-scroll-v3|production-plan-tabs-v1|production-plan-product-v[23]|production-plan-detail-v1)-(?:dev|prd)/);
});
