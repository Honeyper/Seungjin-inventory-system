...
test("PC 제품 이미지와 하단 썸네일 영역 사이에 여백을 유지한다", () => {
  ...
  assert.match(adminHtml, /styles\.css\?v=(?:20260916-product-column-widths-v1|20260916-label-treatment-visibility-v1|20260916-myeongsin-client-v1|20260916-label-process-v1|20260916-pc-inventory-confirm-v1|20260915-inbound-defect-upload-v1|20260915-production-print-fix-v1|20260915-order-actions-menu-v1|20260914-shipping-status-sync-v1|20260914-order-manual-completion-v1|20260911-(?:production-plan-(?:width|rows)|print-page-isolation|inventory-audit-search|production-plan-delete|production-capacity|production-inputs|remainder-save)-v1|20260910-(?:invoice-preview-clear|update-history|notification-scroll-v3|production-plan-tabs-v1|production-plan-product-v[23]|production-plan-detail-v[1234]))-(?:dev|prd)/);
});
