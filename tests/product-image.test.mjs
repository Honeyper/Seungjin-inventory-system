...
test("긴 모바일 제품명은 글꼴 로딩 뒤에도 실제 폭에 맞춰 축소하고 필요하면 줄바꿈한다", () => {
  ...
  assert.match(mobileHtml, /mobile\.js\?v=(?:20260915-production-print-fix-v1|20260915-order-actions-menu-v1|20260914-shipping-status-sync-v1|20260910-product-image-track|20260911-inventory-move-persistence-v1)-(?:dev|prd)/);
});
