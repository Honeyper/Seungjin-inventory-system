...
test("새 박스 상태 필드를 받도록 이전 재고 캐시를 무효화한다", () => {
  ...
  assert.match(adminHtml, /admin\.js\?v=20260910-(?:inventory-attachments|update-history(?:-v2)?|notification-scroll-v3|production-plan-tabs-v1|production-plan-product-v2)-(?:dev|prd)/);
});
