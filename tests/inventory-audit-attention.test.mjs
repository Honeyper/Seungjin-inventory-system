...
test("실물 확인 상세는 미확인 박스와 확인 완료 박스를 구분한다", () => {
  assert.match(adminSource, /재고조사 대상 박스를 확인 상태별로 구분합니다/);
