...
function harness() {
  ...
  const calls=[],toasts=[];let saved=null;
  const context=vm.createContext({
    ...
    closeRemainingInventoryModal:()=>{},closeInboundDetailModal:()=>{},loadInventoryDashboard:async()=>true,refreshInventoryDashboardAfterMutation:async()=>true,
  ...
  return {context,initial,calls,toasts,getSaved:()=>saved};
}
