...
test("관리자 알림 버튼은 백업 결과 API, 읽음 표시, 실패 상세를 연결한다", () => {
  ...
  assert.match(adminHtml, /styles\.css\?v=20260910-(?:invoice-preview-clear|update-history|notification-scroll-v3|production-plan-tabs-v1|production-plan-product-v[23]|production-plan-detail-v[123])-(?:dev|prd)/);
